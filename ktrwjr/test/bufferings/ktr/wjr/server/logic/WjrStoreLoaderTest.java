...
public class WjrStoreLoaderTest {
	...
	public void listClassFiles_CanListClassFiles() {
		File parentDir;
		parentDir = new File("war/WEB-INF/classes/bufferings/ktr/wjr/server/fortest");
	...
	public void getClassNameFromClassFile_CanGetName() {
		File classFile = new File("war/WEB-INF/classes/bufferings/ktr/wjr/server/fortest/ForTest.class");
		String ret = storeLoader.getClassNameFromClassFile("war/WEB-INF/classes", classFile);
