...
import static bufferings.ktr.wjr.shared.util.Preconditions.checkArgument;
...
public class WjrMethodItem extends WjrStoreItem {
	...
	/**
	 * The cpu time the run test took. The unit is [cpu_ms]. This cannot be
	 * null.
	 */
	...
	public String getMethodRunnerName() {
		return methodRunnerName;
	}

	public void setMethodRunnerName(String methodRunnerName) {
		this.methodRunnerName = methodRunnerName;
	}

	protected String methodRunnerName;
	protected String resultsHTML;
	...
	public WjrMethodItem(String className, String methodName, String methodRunnerName) {
		checkNotNull(className, "The className parameter is null.");
		checkArgument(className.length() > 0, "The className parameter is empty.");
		checkNotNull(methodName, "The methodName parameter is null.");
		checkArgument(methodName.length() > 0, "The methodName parameter is empty.");
	...
	/**
	 * Sets the trace string of the run test. If the trace parameter is null,
	...
	/**
	 * Gets the api time the run test took. The unit is [api_cpu_ms]. This
	 * cannot be null.
	 * 
	...
	public void copyResult(WjrMethodItem to) {
		...
		checkArgument(classAndMethodName.equals(to.getClassAndMethodName()), "The classAndMethodName is different.");
		to.setState(state);
		to.setTrace(trace);
		to.setTime(time);
	...
	public void setResults(String resultsHTML) {
