...
public class WjrConfig {
	 ...
	 */
	public static final boolean DEFAULT_CPUMS_ENABLED = false;

	/**
	 * The default value of apimsEnabled.
	 */
	public static final boolean DEFAULT_APIMS_ENABLED = false;
	 ...
	 * 
	 * @param value
	 *            The interval seconds before retrying the test when the over
	 *            quota exception
	 */
	public void setRetryOverQuotaInterval(String value) {
		int temp = parseInt(value, DEFAULT_RETRYOVERQUOTA_INTERVAL);
		retryOverQuotaInterval = checkRange(temp, RETRYOVERQUOTA_INTERVAL_MIN, RETRYOVERQUOTA_INTERVAL_MAX);
	}
	...
	public void setRetryOverQuotaMaxCount(String value) {
		...
		retryOverQuotaMaxCount = checkRange(temp, RETRYOVERQUOTA_MAXCOUNT_MIN, RETRYOVERQUOTA_MAXCOUNT_MAX);
	}

	/**
	 * Parses the string value.
	 * 
	 * If the value is null or empty, returns the defaultValue, otherwise
	 * returns the value.
	 * 
	 * @param value
	 *            The value to parse.
	 * @param defaultValue
	 *            The default value.
	 * @return If the value is null or empty, returns the defaultValue,
	 ...
	 * @param defaultValue
	 *            The default value.
	 * @return If the value equals to "true", returns true. If the value equals
	 *         to "false", returns false. Otherwise, returns the default value.
	 */
